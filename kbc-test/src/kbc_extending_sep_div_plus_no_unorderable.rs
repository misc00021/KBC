...
("math_no_diff_int_sep_div_plus_KBC_max_rules_100_extended_no_unorderable".to_string(), vec![
...
("math_no_diff_int_sep_div_plus_KBC_max_rules_150_extended_no_unorderable".to_string(), vec![
...
("math_no_diff_int_sep_div_plus_KBC_max_rules_200_extended_no_unorderable".to_string(), vec![
...
("math_no_diff_int_sep_div_plus_KBC_max_rules_40_extended_no_unorderable".to_string(), vec![
rw!("rule_0"; "(+ ?x ?y)" => "(+ ?y ?x)"),
rw!("rule_1"; "(+ ?x 0)" => "?x"),
rw!("rule_2"; "(+ 0 ?x)" => "?x"),
...
("math_no_diff_int_sep_div_plus_KBC_max_rules_60_extended_no_unorderable".to_string(), vec![
rw!("rule_0"; "(+ ?x ?y)" => "(+ ?y ?x)"),
rw!("rule_1"; "(+ ?x 0)" => "?x"),
rw!("rule_2"; "(+ 0 ?x)" => "?x"),
rw!("rule_3"; "(* ?x ?x)" => "(pow ?x 2)"),
...
("math_no_diff_int_sep_div_plus_KBC_max_rules_80_extended_no_unorderable".to_string(), vec![
