...
rw!("div-d-d"; "(/ ?d ?d)" => "1" if is_not_zero("?d")),
...
rw!("times-x-recip-d"; "(* ?x (/ 1 ?d))" => "(/ ?x ?d)" if is_not_zero("?d")),
rw!("div-zero-d"; "(/ 0 ?d)" => "0" if is_not_zero("?d")),
...
rw!("times-d-divxd"; "(* ?d (/ ?x ?d))" => "?x" if is_not_zero("?d")),
rw!("times-x-timesxy"; "(* ?x (* ?x ?y))" => "(* (pow ?x 2) ?y)"),
rw!("div-pow2-d"; "(/ (pow ?d 2) ?d)" => "?d" if is_not_zero("?d")),
...
rw!("times-recip-d-x"; "(* (/ 1 ?d) ?x)" => "(/ ?x ?d)" if is_not_zero("?d")),
...
rw!("times-x-divyd"; "(* ?x (/ ?y ?d))" => "(/ (* ?x ?y) ?d)" if is_not_zero("?d")),
rw!("div-timesxd-d"; "(/ (* ?x ?d) ?d)" => "?x" if is_not_zero("?d")),
rw!("times-x-minusx-1"; "(* ?x (- ?x -1))" => "(+ ?x (pow ?x 2))"),
rw!("minus-x-minus0y"; "(- ?x (- 0 ?y))" => "(+ ?x ?y)"),
rw!("plus-x-div-neg1-d"; "(+ ?x (/ -1 ?d))" => "(- ?x (/ 1 ?d))" if is_not_zero("?d")),
